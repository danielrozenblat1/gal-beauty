...
export default function BasicAccordion() {
  ...
  return (
    ...
    <div className={styles.title} id="שאלות נפוצות" itemProp="mainEntity" itemScope itemType="https://schema.org/WebPage">שאלות נפוצות</div>
      ...
      <DropdownAccordion title="איך עובד תהליך ההחלמה? " content="בסיום הטיפול יתכן ותהיה נפיחות ורגישות בשפתיים, בימים הראשונים לאחר הטיפול העור בשפתיים יתייבש ויתחיל להתקלף,מתחת לקילוף הגוון יתחיל לצוץ ואחרי חודש וחצי בממוצע התוצאה הסופית מתחילה להתקבל" />
...
2. המחט של פיגמנט השפתיים הרבה יותר עדינה ודקה <br/>
